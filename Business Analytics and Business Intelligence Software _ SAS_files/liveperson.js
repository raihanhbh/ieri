...
lpMTagConfig.lpTagSrv = lpMTagConfig.lpTagSrv || "server.iad.liveperson.net";
lpMTagConfig.lpServer = lpMTagConfig.lpServer || "server.iad.liveperson.net";
lpMTagConfig.lpNumber = lpMTagConfig.lpNumber || "42179880";
lpMTagConfig.deploymentID = (lpMTagConfig.deploymentID || window.lpUnit || "service");

if (!lpMTagConfig.containsUnit) {
    lpMTagConfig.vars.push(["page","unit",(window.lpUnit || "service")]);
}
if (!lpMTagConfig.containsLanguage) {
    lpMTagConfig.vars.push(["session","language",(window.lpLanguage || "usen")]);
}
